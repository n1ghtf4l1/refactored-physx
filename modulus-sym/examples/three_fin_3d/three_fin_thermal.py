...
def run(cfg: ModulusConfig) -> None:
    ...
    file_path = "modulus-sym/examples/three_fin_3d/openfoam/"
    if os.path.exists(to_absolute_path(file_path)):
        ...
        if cfg.custom.turbulent:
            openfoam_var = csv_to_dict(
                to_absolute_path("modulus-sym/examples/three_fin_3d/openfoam/threeFin_extend_zeroEq_re500_fluid.csv"),
                mapping,
            )
        else:
            openfoam_var = csv_to_dict(
                to_absolute_path("modulus-sym/examples/three_fin_3d/openfoam/threeFin_extend_fluid0.csv"), mapping
            )
        ...
        if cfg.custom.turbulent:
            openfoam_var = csv_to_dict(
                to_absolute_path("modulus-sym/examples/three_fin_3d/openfoam/threeFin_extend_zeroEq_re500_solid.csv"),
                mapping,
            )
        else:
            openfoam_var = csv_to_dict(
                to_absolute_path("modulus-sym/examples/three_fin_3d/openfoam/threeFin_extend_solid0.csv"), mapping
            )
